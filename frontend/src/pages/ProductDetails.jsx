...
const ProductDetail = () => {
    ...
    if (!product) {
        return <p className="text-center text-red-500 w-full h-screen flex justify-center items-center">Sorry, we don't sell that product Online</p>;
    }
        ...
        <div className="p-6 pt-30 flex flex-col md:flex-row gap-8 bg-white w-full h-screen">
            ...
            <div>
                ...
                <div className=" mt-4 flex gap-5">
                    <p className="text-center font-nunito text-sky-900 text-lg">Current Quantity : </p>
                    <div className="flex gap-4">
                        {/* <MinusIcon color="white" className="bg-sky-900 cursor-pointer" /> */}
                        <input type="text" value={1} className="w-10 text-center border-sky-900 border-2 outline-none rounded-md " disabled/>
                        {/* <PlusIcon color="white" className="bg-sky-900 cursor-pointer"/> */}
                    </div>
                </div>
                    <p className="text-sky-400 text-sm font-extralight pt-4">Note : *You can change the quantity by clicking buy now button*</p>
